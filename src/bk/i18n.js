...
const BK_STRINGS = {
  uz: {
    ...
    arenda:
      "Ижара: актуал маълумотни парк менежеридан олинг.\n\nҚайтиш: /start",
  ...
  ru: {
    ...
    arenda:
      "Аренда транспорта: здесь будет актуальный контент от партнёров парка. Напиши менеджеру или уточни в чате парка условия и доступные города.\n\nКоманда для возврата: /start",
  ...
  tg: {
    ...
    arenda:
      "Иҷора: маълумотро аз менеҷери парк гиред.\n\nБозгашт: /start",
  ...
  ky: {
    ...
    arenda:
      "Аренда: актуалдуу маалыматты парк менеджеринен алыңыз.\n\nКайтуу: /start",
