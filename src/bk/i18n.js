...
const BK_STRINGS = {
  uz: {
    ...
    yx_ask_uz_doc: "Выберите тип подтверждающего документа (Узбекистан / Таджикистан).",
    yx_ask_kz_doc: "Выберите тип документа (Казахстан / Кыргызстан).",
    yx_ask_tm_visa: "Укажите тип визы / основания пребывания (Туркменистан).",
    ...
    yx_p_req_video:
      "Запишите короткое видео: вы с паспортом и банковской картой (лицо и данные читаемы).",
    yx_p_req_photo:
      "Отправьте фото: вы с паспортом и картой (лицо и реквизиты читаемы).",
    yx_p_req_text:
    ...
    yx_p_tm_visa: "Фото визы / разрешения.",
