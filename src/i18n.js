...
export const STRINGS = {
  uz: {
    ...
    pick_service: "Қайси сервисда ишламоқчисиз?",
    pick_tariff: "Қайси тарифда ишламоқчисиз?",
    ask_phone_step:
      "📱 Мобил телефон\n\nИшчи мобил рақамингизни ёзинг ёки контакт юборинг.",
    ...
    service_taximeter: "Таксометр Парк",
    tariff_foot_bike: "🚶 Пеша ва 🚲 Велосипед",
    tariff_car: "🚗 Авто",
  ...
  ru: {
    greet: "Здравствуйте! Добро пожаловать в бота Doda taxi. Выберите язык для регистрации.",
    pick_language: "Выберите язык:",
    pick_service: "В каком сервисе хотите работать?",
    pick_tariff: "На каком тарифе хотите работать?",
    ask_phone_step:
      "📱 Мобильный телефон\n\nУкажите рабочий номер или отправьте контакт.",
    ...
    docs_collect_intro:
      "Дальше мы запросим документы по одному. Нажмите кнопку, чтобы начать.",
    ...
    service_yandex_lavka: "Яндекс Лавка",
    service_taximeter: "Таксометр Парк",
    tariff_foot_bike: "🚶 Пешком и 🚲 Велосипед",
    tariff_car: "🚗 Авто",
  ...
  tg: {
    ...
    ask_phone_step:
      "📱 Телефони мобилӣ\n\nРақами кории худро нависед ё контакт фиристед.",
    ...
    service_yandex_lavka: "Яндекс Лавка",
    service_taximeter: "Таксометр Парк",
    tariff_foot_bike: "🚶 Пиёда ва 🚲 Дучарха",
    tariff_car: "🚗 Мошин",
    tariff_truck: "🚚 Боркаш",
  ...
  ky: {
    ...
    ask_phone_step:
      "📱 Мобилдик телефон\n\nИштөөчү номериңизди жазыңыз же контакт жөнөтүңүз.",
    ...
    docs_collect_intro:
      "Кийинки кадамда керектүү документтерди бири-бирден сурайбыз. Баштоо үчүн баскычты басыңыз.",
    ...
    service_yandex_lavka: "Яндекс Лавка",
    service_taximeter: "Таксометр Парк",
    tariff_foot_bike: "🚶 Жөө ва 🚲 Велосипед",
    tariff_car: "🚗 Унаа",
